...
for line in open(fname):
  inputs += [Node(None, -1, eval(line.strip()))]

cur_val = inputs[0]
print cur_val.str()
for new_val in inputs[1:]:
  cur_val = cur_val.add(new_val)
  did_something = True
  while did_something:
    did_something = cur_val.maybe_explode() or cur_val.maybe_split()
    print cur_val.str()
  print cur_val.str()

print cur_val.magnitude()
